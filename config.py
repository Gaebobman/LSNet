...
parser.add_argument('--train_root', type=str, default='/home/1_Dataset/RGBT/RGBT_dataset/train', help='the train images root')
parser.add_argument('--val_root', type=str, default='/home/1_Dataset/RGBT/RGBT_dataset/val', help='the val images root')
...
parser.add_argument('--test_path',type=str,default='/home/1_Dataset/RGBT/RGBT_dataset/test/',help='test dataset path')
